...
for %%S in (run_right dash_turn jump fast_fall short_hop host_launch host_ledge_fall jump_height_split double_jump host_impulse combat downb_transitions upb audio) do (
