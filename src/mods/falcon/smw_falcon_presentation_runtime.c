...
static const uint8_t k_audio_sha256[11][32] = {
 ...
 {0xc7,0x98,0xd8,0x31,0x04,0xeb,0x13,0xa8,0x2e,0xee,0xb1,0xda,0x74,0x5d,0xed,0x7f,0x30,0x9b,0x94,0x87,0x22,0x1a,0xd0,0xc5,0x90,0x06,0x04,0x2f,0x0b,0x90,0xd8,0xfb},
...
static int load_final_cache(const char *cache) {
    ...
    if (!verify_audio_cache(cache, audio_dir, sizeof(audio_dir)) ||
        !smw_falcon_audio_activate(audio_dir))
